...
def monitor_hardware():
    ...
    global inactiveSwitch  # Declare inactiveSwitch as global
    ...
    try:
        while True:
            ...
            log_event(f"Current state: {get_printer_status()['status']}")
            print('--------------------------------------------------------------------------------------------*')

            if get_printer_status()['status'] == "Printing" and inactiveSwitch:
            ...
            elif get_printer_status()['status'] == "Printing" and not inactiveSwitch:
            ...
            elif get_printer_status()['status'] != "Printing" and inactiveSwitch:
